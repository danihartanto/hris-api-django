# danihartanto sample application
...
```sh
$ git clone https://github.com/danihartanto/hris-api-django.git
$ cd hris-api-django
```
...
application, use the value `http://127.0.0.1:8000/api/docs/`. This is to
